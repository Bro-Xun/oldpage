!function(e, t) {
	...
	function throw_lrc(){
	if(splash==true){
		lrc_current=document.getElementsByClassName("aplayer-lrc-current")[0].innerHTML;
		if(lrc_current=="Not available"){
		   lrc_current="纯音乐请欣赏"
		   }
		else{
		   //
	...
	function splashlrc(){
		...
		var colorArr=["pink","green","yellow","aqua"]
			var baseX = Xp;
			var baseY = Yp;
			var new_span=document.createElement('span');
			new_span.innerText=lrc_current;
			new_span.style.position='fixed';
			new_span.style.left=baseX-10+'px';
			new_span.style.top=baseY+'px';
			new_span.style.color=colorArr[parseInt(Math.random()*colorArr.length)];
